...
module.exports = {
    name: "limitelimite",
    description: "faire un limitelimite INCROYABLE SUR DISCORD",
    category: "activite",
    aliases: ["ll"],
    ...
    async execute(message, args) {
        ...
        if(message.member.voice.channel) {
            fetch(`https://discord.com/api/v8/channels/${message.member.voice.channel.id}/invites`, { 
                method: "POST",
                body: JSON.stringify({ max_age: 86400, max_uses: 0, target_application_id: "879863881349087252", target_type: 2, temporary: false, validate: null }),
